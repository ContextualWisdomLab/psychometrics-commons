...
const ASSESSMENT_SESSION_MIGRATION: &str =
    include_str!("../migrations/0020_assessment_session.sql");
...
/// field fails closed. Session and participant references are already validated
/// and normalized by [`AssessmentSession::new`], so this adapter does not add an
/// unreachable second reference-validation layer.
///
/// # Errors
///

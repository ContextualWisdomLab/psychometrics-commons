...
impl ResponseLedger {
    ...
    /// # Errors
    ///
    /// Returns [`WriteError::InvalidReference`] for an invalid or non-exact identity
    /// reference, [`WriteError::EmptyReference`] for a blank payload digest,
    ...
    /// # Errors
    ///
    /// Returns [`WriteError::InvalidReference`] for an invalid or non-exact snapshot

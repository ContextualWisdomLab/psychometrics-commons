...
- Versioned cross-service integration envelopes plus bounded outbox retry/quarantine and consumer-scoped inbox deduplication semantics, preserving exact replay idempotency, digest-conflict fail-closed behavior, and safe audit evidence before physical persistence adapters are introduced.

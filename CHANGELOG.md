...
- Repository `CLAUDE.md` and architecture-view index so coding agents and reviewers can navigate the same PRD/TRD/ADR/traceability contracts without introducing a second source of truth.

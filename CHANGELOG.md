...
- Anonymous-first participant records with stable product-owned identity and optional Keyverse subject linking that requires proof references for both anonymous and authenticated control, preserves exact replay idempotency, and rejects silent in-place rebinding of historical participant identity.

...
- Participant export/deletion request lifecycle primitives that require request-specific identity verification, preserve durable operation/completion evidence, keep event time monotonic, and represent legal retention exceptions as explicit partial deletion completion rather than a misleading deletion boolean.

...
After fetching `origin`, protected `main` is `503a4e640eeba0f5e126fa4c4078d8d21aebb93b`; merged PR #258 is included in that head. The latest successful GitHub REST listing observed 72 open PRs. The following is the current buyer-impact and gate-critical exact-head subset, refreshed from `refs/pull/*/head`; it is not a claim that any row is merge-ready.

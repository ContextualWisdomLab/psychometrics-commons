...
|---|---|---|
| Public assessment transport | #197 (Draft), #415 | Item-delivery and response-recording HTTP remain outside protected main; reconcile each against the persisted session/ledger boundary before adding browser E2E. |
| Durable response ledger | #427 | Current head `765e6f8a05ebee91ac7527097b8bc78961f9e74f` is open, non-Draft, and `MERGEABLE` but `BLOCKED`; Runtime, production line/branch coverage, package provenance, current-head OpenCode review, Strix, and Devin are being revalidated, with no independent approval. The prior `13647/13648` line-coverage accounting was repaired without changing response-event behavior; merge still requires terminal exact-head evidence. |
| Durable parity and fail-closed hardening | #279, #292, #302, #318, #331, #398, #400–#403, #409, #411, #419, #420, #421, #427, #428–#433 | These are active or reconciliation lanes, not protected-main truth; process dependency order and current-head evidence before merge decisions. |
...
| CEFR and documentation targets | #426, #435; issues #424 and #425 | #426 is a Draft design lane; #435 is Ready for review at current head `ec08423c5af46114fe667197479849aa34bef6c9`, but its new hosted checks and independent review must be revalidated; scientific/right-cleared English A1–B2 publication and released-contract consumption remain product targets until evidence and ownership are implemented. |

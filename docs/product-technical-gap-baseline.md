...
| [282](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/282) | `cf8a6f0c` | `main` | Exact head verified after lint repair: real PostgreSQL parity 3/3, fmt, clippy `-D warnings`; required checks queued and no independent approval |

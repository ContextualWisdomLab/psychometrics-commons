...
| [282](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/282) | `d63c76d0e104809c979aaa5a7a76851fabfe8385` | `main` | Exact head verified: real PostgreSQL `cargo test --all-targets`, fmt, clippy, and rustdoc passed; CodeRabbit success/Devin pending, with no independent approval or protected merge |
...
| [284](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/284) | `edc80ffe35991fe9d65495a16560f479120e6c61` | `main` | Exact head verified: real PostgreSQL `cargo test --all-targets`, fmt, clippy, and rustdoc passed; Devin/CodeRabbit review reruns pending, with no independent approval or protected merge |

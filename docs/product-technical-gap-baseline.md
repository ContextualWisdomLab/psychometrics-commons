...
| [263](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/263) | docs: establish current product technical gap baseline | `feat/product-technical-gap-baseline-20260820` | `817ec3e` | Ready | 2026-08-20 |
...
| [276](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/276) | `5bf24fd73b44e41ddfdad203ff88d6ca691c9339` | `main` | Concurrent docs/test commits observed; revalidation must use this current head, not prior `1deb394` |

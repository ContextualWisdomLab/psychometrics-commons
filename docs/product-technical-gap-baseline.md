...
| [257](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/257) | `15a81b3a` | `main` | Exact head repaired result-read provenance; focused contract 8/8, fmt/clippy/rustdoc passed; required checks queued and no independent approval |
| [263](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/263) | `7b824a72b01c2ee96979eb4b5302198de337bbc1` | `main` (`4499d9c…`) | Documentation refresh pushed; CodeRabbit/Devin and protected workflows are pending on this exact head; 0 open threads, 0 independent approvals |

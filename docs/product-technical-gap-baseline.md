...
| Durable response ledger | #427 | Current head `9c13e79c603c40fc1bd746b2d9086e162717cfee` is open, non-Draft, and `MERGEABLE` but `BLOCKED`; hosted production line coverage, OpenCode current-head review, and Strix are failed, with no independent approval. Local CI-equivalent line coverage is `13647/13648`, not a passing 100% result; repair the evidence-backed failures before merge. |
| Durable parity and fail-closed hardening | #279, #292, #302, #318, #331, #398, #400–#403, #409, #411, #419, #420, #421, #428–#433 | These are active or reconciliation lanes, not protected-main truth; process dependency order and current-head evidence before merge decisions. |
...
| CEFR and documentation targets | #426; #435; issues #424 and #425 | #426 remains a Draft design lane; #435 is a stacked Draft consumer pin at exact upstream PR #5 head `ec9a2aa3…`; scientific/right-cleared English A1–B2 publication, released-contract conformance, and runtime consumption remain product targets until evidence and ownership are implemented. |

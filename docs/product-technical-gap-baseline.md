...
| [284](https://github.com/ContextualWisdomLab/psychometrics-commons/pull/284) | `edc80ffe35991fe9d65495a16560f479120e6c61` | `main` (PR base `503a4e…`; protected main now `4499d9c…`) | Exact head verified: real PostgreSQL `cargo test --all-targets`, fmt, clippy, and rustdoc passed; CodeRabbit/Devin success, protected workflows queued, 0 open threads, 0 independent approvals |

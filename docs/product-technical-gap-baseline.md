...
| Durable response ledger | #427 | Pushed repair head `e5047cdf1aa16473f9f57d61ab06c33b1bcb4d6c`; at the snapshot it was open, non-Draft, `MERGEABLE` but `BLOCKED`, with checks queued/in progress and no independent approval. Reverify the same head after hosted checks complete. |

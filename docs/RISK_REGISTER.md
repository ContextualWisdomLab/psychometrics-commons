...
| Research release contains operational/Keyverse/linkage identifier | critical | medium | implementation_in_progress | restricted linkage persistence Active PR #175 plus program-scoped `public_research_identity` load; adversarial release pipeline pending |

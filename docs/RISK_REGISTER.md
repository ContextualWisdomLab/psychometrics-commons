...
| Research release contains operational/Keyverse/linkage identifier | critical | medium | implementation_in_progress | Active PR public-fixture identifier scan plus restricted-linkage architecture; adversarial release pipeline pending |

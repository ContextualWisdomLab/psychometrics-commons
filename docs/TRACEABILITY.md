...
| No operational IDs in public research release | TRD §14–15; Research Governance | architecture policy; Active PR stack #265–#268 extends the scanner with prefixed/separator alias rejection and structured-value fail-closed behavior | release fixture/static/runtime leakage tests |

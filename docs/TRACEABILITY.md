...
| Deterministic narrative fallback | PRD §3.2, §9.5 | TRD §17; Architecture narrative view | ADR-0009, ADR-0010, ADR-0018 | **Implemented** through merged #287: published narrative, style-mapping, interpretation-unit, and approved-selection references reject padded or noncanonical spelling before deterministic rendering; remaining narrative runtime mapping is Target |

...
| Research release manifests | PRD §5 | TRD §15 | ADR-0007, ADR-0010 | **Active PR #409** adds product-side fail-closed public-fixture identity-inventory, column/value, and structured-cell validation in `src/research_release.rs`; it is not protected-main truth, and semantic-data-portal remains the External dependency |

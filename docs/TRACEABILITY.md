...
| English A1-B2 CEFR profile consumer | PRD §6.1, §9.11 | TRD §8.1; immutable external contract and result evidence binding | ADR-0021 | **Active PR #435** (`54a9559c…`, stacked on baseline #434) provides a review-only product boundary in `src/cefr_language_assessment.rs` and pins upstream Draft PR #5 head `ec9a2aa3…` plus schema digests; upstream release, schema-validator execution, instrument persistence, and result transport remain unverified/Target |

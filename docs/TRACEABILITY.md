...
| Instrument release bytes/version/item order are immutable | TRD §7 | `src/instrument.rs` + publication contract tests; **Active PR** `feat/instrument-release-persistence-20260813` persists immutable manifest columns | API publication integration |

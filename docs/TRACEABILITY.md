...
| Headless replaceable clients | PRD §7 | TRD §1, §18; C4 | ADR-0001, ADR-0002 | Architecture established; Active PR instrument catalog HTTP lists startable published releases; remaining public families are Target |

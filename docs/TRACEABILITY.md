...
- Date: 2026-08-17
- Evaluated protected-main implementation baseline: `aac99d0b523b8f765846fc6edad834e5cf903ca8`
...
Current protected-main Rust module surface on `aac99d0b523b8f765846fc6edad834e5cf903ca8`:
...
Still-Target logical modules/adapters include remaining product aggregate persistence/repositories, public/admin HTTP and event transports, live fast-mlsirm/Keyverse/Gyeot/TEPP/semantic-data-portal adapters, research-release staging, complete consumer narrative mapping bundles, longitudinal normalized ingestion, participant identity-link history persistence, runtime health transports/metrics, and Measurement Workbench orchestration.

### Active implementation work that is not protected-main truth

**Active PR** remaining PostgreSQL persist and operator-health HTTP slices are not protected-main truth until unchanged reviewed/check-clean heads are integrated. This baseline records item-delivery ledger persistence (#48), immutable response snapshots (#55), immutable result snapshots (#51), deterministic narrative fallback (#73), dual-proof account linking (#85), anonymous credential lifecycle (#84), data-rights processing-start (#76), stored result and data-rights authorization (#243/#244), atomic scoring-dispatch persist (#68), exclusive outbox delivery leases (#105/#60), inbox claim-expiry fencing (#81), and recovery invariants (#72). Created assessment-session persistence, identity-link history persistence, response-event persistence, scoring-completion outbox, research-release/contribution persist, data-rights completion, and HTTP health-probe work remain Active PR only.

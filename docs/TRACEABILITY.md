...
| Instrument release bytes/version/item order are immutable | TRD §7 | `src/instrument.rs` + publication contract tests; **Active PR #50** persists immutable manifest columns | API publication integration |

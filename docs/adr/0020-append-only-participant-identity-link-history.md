...
- Active-PR persistence evidence: successor of PR #192 `migrations/0022_participant_identity_link.sql`, `src/postgres_participant_identity_link.rs`, and `src/account_link_write.rs` remain `IMPLEMENTED_ON_ACTIVE_PR` until merged. Prefer that inspect-then-write-and-unlink head over #192, #183, #178, #173, #169, #160, #158, #147, #133, #124, and #114.

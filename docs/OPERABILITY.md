...
6. identity-link unique enforcer rebuilt from unterminated history via `reconcile_identity_link_current_projections` before new account-link writes, so ended issuer-scoped subjects are free and unterminated subjects stay unique;

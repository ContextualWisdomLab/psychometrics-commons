...
| Machine-readable OpenAPI / AsyncAPI | **Active PR** account-link OpenAPI 3.2.0 in `openapi/account-links.yaml`; remaining families and AsyncAPI are not as-built | Keep the account-link document limited to persist/recover/unlink. Do not publish aspirational operations as deployed. |

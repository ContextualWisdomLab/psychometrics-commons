...
| Machine-readable OpenAPI / AsyncAPI | **Active PR for POST /v1/sessions only** | `contracts/openapi-public-v1.yaml` lists the implemented create-session operation. Remaining families and AsyncAPI stay omitted until those transports exist. |

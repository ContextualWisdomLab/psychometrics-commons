...
- **Evidence:** `start_replays_exact_session_after_stored_release_is_suspended`, `start_replays_exact_session_after_stored_release_is_retired`, `persist_rejects_reconstituted_first_insert_after_stored_release_is_suspended`, `persist_rejects_first_insert_when_stored_release_is_missing`, and `persist_rejects_first_insert_when_digest_mismatches_published_row` against real PostgreSQL, plus `exact_start_identity_matches_stored_session_and_rejects_rebind`.

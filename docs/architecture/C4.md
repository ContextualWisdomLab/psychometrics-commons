...
flowchart LR
    ...
    commons -->|immutable CEFR contract/schema references| cefr
    ...
    class keyverse,fast,cefr,gyeot,tepp,portal,orchestrator,batch,egress,inkspan,rank,clearfolio external;
```

...
The successor of PR #202 adds `migrations/0022_participant_identity_link.sql`, `src/postgres_participant_identity_link.rs`, and `src/account_link_write.rs`. Prefer this recover-binding head over #202, #192, #183, #178, #176, #173, #169, #160, #158, #147, #133, #124, and #114. The slice is **Active PR**, not protected-main truth. It stores:

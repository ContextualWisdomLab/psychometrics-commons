...
PR #169 adds `migrations/0022_participant_identity_link.sql` and `src/postgres_participant_identity_link.rs`. Prefer this head over #158, #147, #133, #124, and #114. The slice is **Active PR**, not protected-main truth. It stores:

...
- `scoring_request` version pins persist through `migrations/0011_scoring_request.sql`. **Active PR** #194 reloads that unique `scoring_request_ref` after restart; HTTP scoring transport remains Target.

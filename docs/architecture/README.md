...
| [`RESPONSE_EVENT_PERSISTENCE.md`](RESPONSE_EVENT_PERSISTENCE.md) | How does the Active PR #284 response-event relation preserve idempotency, contiguous restart reconstruction, Rust-equivalent durable identity, and distinct observed/received clocks without claiming protected-main implementation? |

...
DO $instrument_release_encoding_guard$
BEGIN
    IF current_setting('server_encoding') <> 'UTF8' THEN
        RAISE EXCEPTION USING
            ERRCODE = '0A000',
            MESSAGE = 'instrument_release reference parity requires PostgreSQL server_encoding UTF8';
    END IF;
END
$instrument_release_encoding_guard$;

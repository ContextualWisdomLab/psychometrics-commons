...
ALTER TABLE assessment_participant
    ADD CONSTRAINT assessment_participant_created_time_positive_check CHECK (created_at_unix_ms > 0);
...
DROP TRIGGER IF EXISTS assessment_participant_immutable_guard ON assessment_participant;
...
DROP TRIGGER IF EXISTS assessment_participant_truncate_guard ON assessment_participant;

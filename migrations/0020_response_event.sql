...
-- domain. PostgreSQL's POSIX digit/control classes do not cover every Unicode character rejected
-- by the Rust 1.97 reference boundary. The generated int4multiranges below mirror rustc 1.97 /
-- Unicode 17 numeric and Default_Ignorable_Code_Point sets; pg_unicode_fast supplies Unicode

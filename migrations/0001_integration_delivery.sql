...
-- 1.97 `char::is_numeric` is true. The generated numeric int4multirange below is rustc 1.97's
-- Unicode 17 numeric set. The second multirange mirrors the product's explicit Unicode 17
-- Default_Ignorable_Code_Point set so invisible and bidirectional-formatting aliases cannot enter
-- durable authorization, replay, or audit identities. pg_unicode_fast supplies stable Unicode
